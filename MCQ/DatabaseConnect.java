...
public class DatabaseConnect {
    ...
    public DatabaseConnect()
    {
        ...
        cntn=DriverManager.getConnection("jdbc:mysql://localhost:3306/javaquiz","root","");
        }
        catch(Exception e)
        {
    ...
    public int save(String fullname, String address,String contact,String email,String password)
    {
        ...
        try
        {
            ...
            pst=cntn.prepareStatement("Insert into Student values(null,?,?,?,?,?)") ;
    ...
    public int login(String fullname,String password)
    {
        ...
        try
        {
            ...
            pst=cntn.prepareStatement("SELECT * FROM student WHERE FullName=? and Password=?");
...
//            JOptionPane.showMessageDialog(this, "Login successfull",JOptionPane.INFORMATION_MESSAGE);
     ...
     public int update(String name,String add,String contact,String email)
    {
     ...
     public ArrayList<String> getQuestion(String question) 
     {
         ...
         try
         {
             String query=("Select * from question Where SubjectName = ?");
