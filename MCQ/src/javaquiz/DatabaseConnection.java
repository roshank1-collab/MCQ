...
public class DatabaseConnection {
    ...
    public DatabaseConnection()
    {
        ...
        cntn=DriverManager.getConnection("jdbc:mysql://localhost:3307/javaaggignment","root","");
        }
        catch(Exception e)
        {
    ...
    public int save(String fullname, String address,String contact,String email,String password)
    {
        ...
        try
        {
            ...
            pst=cntn.prepareStatement("Insert into signup values(null,?,?,?,?,?)") ;
    ...
    {
        String alpha="1234567890abcdefghijklmnopqr";
        String token="";
    ...
    public int login(String fullname,String password)
    {
        ...
        try
        {
            ...
            pst=cntn.prepareStatement("SELECT * FROM signup WHERE Name=? and Password=?");
...
//            JOptionPane.showMessageDialog(this, "Login successfull",JOptionPane.INFORMATION_MESSAGE);
    ...
    public int insert(String subname, String question,String option1,String option2,String option3,String option4,String correctans)
    {
        ...
        try
        {
            pst=cntn.prepareStatement("Insert into questions values(null,?,?,?,?,?,?,?)") ;
    ...
    {   
        ...
        try
        {
        pst=cntn.prepareStatement("Delete from question where CorrectAns=?");
     ...
     public int update(String name,String add,String contact,String email)
    {
        int result=0;
        try {
            pst=cntn.prepareStatement("Update student set FullName=?, Address=?, Contact=? where Email=?");
     ...
     public ArrayList<String> getQuestion(String Questions) 
     {
         ...
         try
         {
             String query=("Select * from questions Where SubjectName = ?");
             ...
             while(rs.next())
             {
                 quearr.add(rs.getString("Questions"));
                 ...
                 quearr.add(rs.getString("CorrectAns"));
             }
