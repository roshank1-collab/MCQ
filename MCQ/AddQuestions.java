...
public class AdminDashboard extends JFrame implements ActionListener{
    ...
    public AdminDashboard(){
        ...
        cmbsub.addItem("Computer Network");
        ...
        btninsert.setBounds(100,240,75,30);
        btnreset.setBounds(200,240,75,30);
        btndelete.setBounds(100,290,75,30);
        btnupdate.setBounds(200,290,75,30);
        btnlogout.setBounds(400,400,80,30);
       ...
       JLabel background;
       image =new ImageIcon("laptop.jpg");
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
            ...
            {
                try{
                DatabaseConnect db=new DatabaseConnect(); //Database connect
